    ...
    for year in years:
        ...
        # url = 'https://api.edmunds.com/api/vehiclereviews/v2/honda/accord/2015?' + fmt_api_key
            ...
            for review in json['reviews']:
                ...
                new_record = ['subaru',year, model, text_review, userRating, styleId, id, purchaseDate, pricePaid, odometerMiles, title, commentsCount, averageRating,  rearSeats, frontSeats, comfortRating, gettingInOut,
...
records_df = pd.DataFrame(records, columns= ['brand', 'year', 'model','text_review', 'userRating', 'styleId', 'id', 'purchaseDate', 'pricePaid', 'odometerMiles',
...
try:
    ...
    records_df.to_excel('new_t_subaru.xlsx')
    print "excel created"
except Exception,e:
    print e
